package com.mirror.xiaohongshu.data.align.consumer;
...
import com.mirror.xiaohongshu.data.align.model.dto.CollectUnCollectNoteMqDTO;
...
public class TodayNoteCollectIncrementData2DBConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String body) {
        ...
        if (Objects.equals(result, 0L)) {
            ...
            log.info("操作的数据库序号:笔记分区-{}，用户分页-{}", noteIdHashKey,userIdHashKey);
            // 编程式事务，保证多语句的原子性
