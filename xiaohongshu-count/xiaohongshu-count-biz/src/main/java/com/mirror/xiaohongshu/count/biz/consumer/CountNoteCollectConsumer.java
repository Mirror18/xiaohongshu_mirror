...
import com.mirror.xiaohongshu.count.biz.constant.RedisKeyConstants;
import com.mirror.xiaohongshu.count.biz.enums.CollectUnCollectNoteTypeEnum;
import com.mirror.xiaohongshu.count.biz.model.dto.AggregationCountCollectUnCollectNoteMqDTO;
import com.mirror.xiaohongshu.count.biz.model.dto.CountCollectUnCollectNoteMqDTO;
...
//        Map<Long, Integer> countMap = Maps.newHashMap();
        ...
        for (Map.Entry<Long, List<CountCollectUnCollectNoteMqDTO>> entry : groupMap.entrySet()) {
            ...
            creatorId = list.get(0).getNoteCreatorId();
            // 最终的计数值，默认为 0
            int finalCount = 0;
