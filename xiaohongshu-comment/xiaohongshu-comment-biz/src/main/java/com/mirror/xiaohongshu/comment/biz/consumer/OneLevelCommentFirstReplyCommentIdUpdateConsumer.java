...
import com.mirror.xiaohongshu.comment.biz.model.dto.CountPublishCommentMqDTO;
        ...
        if (CollUtil.isNotEmpty(missingCommentIds)) {
            ...
            needUpdateCommentDOS.forEach(needUpdateCommentDO -> {
                ...
                if (Objects.nonNull(earliestCommentDO)) {
                    ...
                    // 异步同步到 Redis
                    threadPoolTaskExecutor.submit(() -> sync2Redis(Lists.newArrayList(earliestCommentId)));
                }
            });
