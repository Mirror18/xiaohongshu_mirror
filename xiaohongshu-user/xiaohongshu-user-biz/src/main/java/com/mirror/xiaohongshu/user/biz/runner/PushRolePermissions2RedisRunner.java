package com.mirror.xiaohongshu.user.biz.runner;
...
import com.mirror.xiaohongshu.user.biz.domain.dataobject.PermissionDO;
import com.mirror.xiaohongshu.user.biz.domain.dataobject.RoleDO;
import com.mirror.xiaohongshu.user.biz.domain.dataobject.RolePermissionDO;
import com.mirror.xiaohongshu.user.biz.domain.mapper.PermissionDOMapper;
import com.mirror.xiaohongshu.user.biz.domain.mapper.RoleDOMapper;
import com.mirror.xiaohongshu.user.biz.domain.mapper.RolePermissionDOMapper;
...
/**
 * @user.bizer: mirror
 * @Date: 2025/1/16 04:22
 * @Description: 推送角色权限数据到 redis中
 */
@Component
@Slf4j
